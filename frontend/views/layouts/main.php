...
use frontend\controllers\Languages;
use yii\helpers\Url;
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="<?= Url:: toRoute('site/index/')?>">Winkel</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="<?php Url::toRoute(['site/index'])?>" class="nav-link">Home</a></li>
                ...
                <?php
                if (Yii::$app->request->cookies->getValue('favorite')) {
                    $countCart = count(Yii::$app->request->cookies->getValue('favorite'));
                } else {
                    $countCart = 0;
                }
                ?>
